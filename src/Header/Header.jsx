...
const Header = () => {
  ...
  return (
    <div>
      <div className="navbar bg-[#f0f3bd]">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-accent font-semibold"
            >
              {navLinks}
            </ul>
          </div>
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 text-accent font-semibold">
            {navLinks}
          </ul>
        </div>
